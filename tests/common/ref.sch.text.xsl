...
<xsl:template match="*[. is nf:get-document-element(.)]"
		...
		<!--ASSERT -->
<xsl:choose>
         <xsl:when test="nf:has-effective-conformance-target(., xs:anyURI('http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/#ReferenceSchemaDocument'))"/>
         <xsl:otherwise>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="base-uri(.)"/>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron"
                          use-when="function-available('saxon:line-number')">
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 3-3: The document MUST have an effective conformance target identifier of http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/#ReferenceSchemaDocument.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M12"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN No simple type disallowed derivation-->


	<!--RULE -->
<xsl:template match="xs:simpleType" priority="1000" mode="M31">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-15: An element {http://www.w3.org/2001/XMLSchema}simpleType MUST NOT have an attribute {}final.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M31"/>
   </xsl:template>
   ...
   <!--PATTERN Enumeration has data definition-->
	...
	<!--RULE -->
<xsl:template match="xs:enumeration" priority="1000" mode="M32">
...
<xsl:choose>
   ...
   <!--PATTERN Complex content uses extension-->


	<!--RULE -->
<xsl:template match="xs:complexContent" priority="1000" mode="M40">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-24: An element {http://www.w3.org/2001/XMLSchema}complexContent MUST have a child {http://www.w3.org/2001/XMLSchema}extension.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M40"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN Simple content uses extension-->


	<!--RULE -->
<xsl:template match="xs:simpleContent" priority="1000" mode="M42">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-26: A complex type definition with simple content schema component must have a derivation method of extension.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M42"/>
   </xsl:template>
   ...
   <!--PATTERN CSCs have SimpleObjectAttributeGroup-->


	<!--RULE -->
<xsl:template match="xs:simpleContent/xs:extension[       for $base in resolve-QName(@base, .),            $base-qname in namespace-uri-from-QName($base) return         (namespace-uri-from-QName($base) = 'http://www.w3.org/2001/XMLSchema'          or (some $type in nf:resolve-type(., $base) satisfies                node-name($type) = xs:QName('xs:simpleType')             )         )      ]"
                 priority="1000"
                 mode="M43">

		<!--ASSERT -->
<xsl:choose>
         <xsl:when test="exists(                         xs:attributeGroup[                           exists(@ref)                           and resolve-QName(@ref, .) = xs:QName('structures:SimpleObjectAttributeGroup')                         ]                       )"/>
         <xsl:otherwise>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="base-uri(.)"/>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron"
                          use-when="function-available('saxon:line-number')">
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-27: A complex type definition with simple content schema component with a derivation method of extension that has a base type definition that is a simple type MUST incorporate the attribute group {http://release.niem.gov/niem/structures/3.0/}SimpleObjectAttributeGroup.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M43"/>
   </xsl:template>
   ...
   <!--PATTERN No complex type disallowed substitutions-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-28: An element {http://www.w3.org/2001/XMLSchema}complexType MUST NOT have an attribute {}block.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M44"/>
   </xsl:template>
   ...
   <!--PATTERN No complex type disallowed derivation-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-29: An element {http://www.w3.org/2001/XMLSchema}complexType MUST NOT have an attribute {}final.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M45"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN No element disallowed substitutions -->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-38: An element {http://www.w3.org/2001/XMLSchema}element MUST NOT have an attribute {}block.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M53"/>
   </xsl:template>
   ...
   <!--PATTERN No element disallowed derivation-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-39: An element {http://www.w3.org/2001/XMLSchema}element MUST NOT have an attribute {}final.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M54"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN Element declaration is nillable-->


	<!--RULE -->
<xsl:template match="xs:element[exists(@name)                                 and (empty(@abstract)                                      or xs:boolean(@abstract) = false())]"
                 priority="1000"
                 mode="M57">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-42: An [element declaration] MUST have the nillable property with a value of true.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M57"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN xs:sequence must be child of xs:extension-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-53: An element {http://www.w3.org/2001/XMLSchema}sequence must be a child of element {http://www.w3.org/2001/XMLSchema}extension.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M68"/>
   </xsl:template>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-55: The schema SHALL NOT contain the element {http://www.w3.org/2001/XMLSchema}choice<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M69"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN Attribute ref defined by conformant schemas-->
	...
	<!--RULE -->
<xsl:template match="xs:attribute[exists(@ref)]" priority="1000" mode="M72">
...
<xsl:choose>
   ...
   <!--PATTERN Only known attribute groups-->
	...
	<!--RULE -->
<xsl:template match="xs:attributeGroup[exists(@ref)]" priority="1000" mode="M73">
...
<xsl:choose>
   ...
   <!--PATTERN No use of xs:any-->
	...
	<!--RULE -->
<xsl:template match="xs:any" priority="1000" mode="M74">
...
<xsl:choose>
   ...
   <!--PATTERN No use of xs:anyAttribute-->
	...
	<!--RULE -->
<xsl:template match="xs:anyAttribute" priority="1000" mode="M75">
...
<xsl:choose>
   ...
   <!--PATTERN No use of xs:unique-->
	...
	<!--RULE -->
<xsl:template match="xs:unique" priority="1000" mode="M76">
...
<xsl:choose>
   ...
   <!--PATTERN No use of xs:key-->
	...
	<!--RULE -->
<xsl:template match="xs:key" priority="1000" mode="M77">
...
<xsl:choose>
   ...
   <!--PATTERN No use of xs:keyref-->
	...
	<!--RULE -->
<xsl:template match="xs:keyref" priority="1000" mode="M78">
...
<xsl:choose>
   ...
   <!--PATTERN No use of xs:selector-->
	...
	<!--RULE -->
<xsl:template match="xs:selector" priority="1000" mode="M79">
...
<xsl:choose>
   ...
   <!--PATTERN No use of xs:field-->
	...
	<!--RULE -->
<xsl:template match="xs:field" priority="1000" mode="M80">
...
<xsl:choose>
   ...
   <!--PATTERN Comments are not recommended-->
	...
	<!--RULE -->
<xsl:template match="comment()" priority="1000" mode="M83">
...
<xsl:choose>
   ...
   <!--PATTERN Schema version must not be empty.-->
	...
	<!--RULE -->
<xsl:template match="xs:schema[exists(@version)]" priority="1000" mode="M93">
...
<xsl:choose>
   ...
   <!--PATTERN No disallowed substitutions-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-83: An element {http://www.w3.org/2001/XMLSchema}schema MUST NOT have an attribute {}blockDefault.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M94"/>
   </xsl:template>
   ...
   <!--PATTERN No disallowed derivations-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 7-84: An element {http://www.w3.org/2001/XMLSchema}schema MUST NOT have an attribute {}finalDefault.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M95"/>
   </xsl:template>
   ...
   <!--PATTERN No use of xs:redefine-->
	...
	<!--RULE -->
<xsl:template match="xs:redefine" priority="1000" mode="M96">
...
<xsl:choose>
   ...
   <!--PATTERN No use of xs:include-->
	...
	<!--RULE -->
<xsl:template match="xs:include" priority="1000" mode="M97">
...
<xsl:choose>
   ...
   <!--PATTERN xs:import must have namespace-->
	...
	<!--RULE -->
<xsl:template match="xs:import" priority="1000" mode="M98">
...
<xsl:choose>
   ...
   <!--PATTERN Name of simple type ends in "SimpleType"-->
	...
	<!--RULE -->
<xsl:template match="xs:simpleType[@name]" priority="1000" mode="M101">
...
<xsl:choose>
   ...
   <!--PATTERN Name of simple type is upper camel case-->
	...
	<!--RULE -->
<xsl:template match="xs:simpleType[exists(@name)]" priority="1000" mode="M102">
...
<xsl:choose>
   ...
   <!--PATTERN External adapter type has complex content-->


	<!--RULE -->
<xsl:template match="xs:complexType[exists(@appinfo:externalAdapterTypeIndicator)]"
                 priority="1000"
                 mode="M106">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 8-9: An external adapter type definition must be a complex type definition with complex content.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M106"/>
   </xsl:template>
   ...
   <!--PATTERN External adapter type uses extension-->


	<!--RULE -->
<xsl:template match="xs:complexType[exists(@appinfo:externalAdapterTypeIndicator)                                     and exists(xs:complexContent)]"
                 priority="1000"
                 mode="M107">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 8-10: An external adapter type definition must be use the extension derivation method.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M107"/>
   </xsl:template>
   ...
   <!--PATTERN External adapter type extends structures:ObjectType-->


	<!--RULE -->
<xsl:template match="xs:complexType[exists(@appinfo:externalAdapterTypeIndicator)                                     and exists(xs:complexContent/xs:extension)]"
                 priority="1000"
                 mode="M108">

		<!--ASSERT -->
<xsl:choose>
         <xsl:when test="for $extension in xs:complexContent/xs:extension return                         resolve-QName($extension/@base, $extension) = xs:QName('structures:ObjectType')"/>
         <xsl:otherwise>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="base-uri(.)"/>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron"
                          use-when="function-available('saxon:line-number')">
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 8-11: An external adapter type definition MUST extend structures:ObjectType.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M108"/>
   </xsl:template>
   ...
   <!--PATTERN External adapter types use sequence-->
...
<xsl:template match="xs:complexType[exists(@appinfo:externalAdapterTypeIndicator)                                     and exists(xs:complexContent/xs:extension)]"
		...
		<!--ASSERT -->
<xsl:choose>
         <xsl:when test="exists(xs:complexContent/xs:extension/xs:sequence)"/>
         <xsl:otherwise>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="base-uri(.)"/>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron"
                          use-when="function-available('saxon:line-number')">
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 8-12: An external adapter type must use sequence as its top-level compositor.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M109"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN Element type does not have a simple type name-->
	...
	<!--RULE -->
<xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M111">
...
<xsl:choose>
   ...
   <!--PATTERN Element type is from conformant namespace-->
	...
	<!--RULE -->
<xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M112">
...
<xsl:choose>
   ...
   <!--PATTERN Augmentable type has augmentation point-->


	<!--RULE -->
<xsl:template match="xs:complexType[                        exists(@name[                          not(ends-with(., 'MetadataType'))                          and not(ends-with(., 'AugmentationType'))])                        and empty(@appinfo:externalAdapterTypeIndicator)                        and exists(child::xs:complexContent)]"
                 priority="1000"
                 mode="M117">
      <xsl:variable name="augmentation-point-qname"
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(xs:complexContent/xs:extension/xs:sequence/xs:element[                               exists(@ref[resolve-QName(., ..) = $augmentation-point-qname])]) = 1"/>
         <xsl:otherwise>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="base-uri(.)"/>
            <xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron"
                          use-when="function-available('saxon:line-number')">
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 8-21: An augmentable type MUST contain exactly one reference its augmentation point element.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M117"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN Augmentation reference is optional-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 8-26: An augmentation element particle MUST have attribute minOccurs equal to 0.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M122"/>
   </xsl:template>
   ...
   <!--PATTERN Augmentation reference is unbounded-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 8-27: An augmentation element particle MUST have attribute maxOccurs set to unbounded.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M123"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN Deprecated annotates schema component-->
	...
	<!--RULE -->
<xsl:template match="*[exists(@appinfo:deprecated)]" priority="1000" mode="M126">
...
<xsl:choose>
   ...
   <!--PATTERN External adapter type indicator annotates complex type-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:text xmlns:sch="http://www.ascc.net/xml/schematron">:assert:</xsl:text>Rule 9-3: The attribute appinfo:externalAdapterTypeIndicator MUST be owned by an element {http://www.w3.org/2001/XMLSchema}complexType.<xsl:value-of xmlns:sch="http://www.ascc.net/xml/schematron" select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M128"/>
   </xsl:template>
...
<xsl:choose>
   ...
   <!--PATTERN LocalTerm annotates schema-->
	...
	<!--RULE -->
<xsl:template match="term:LocalTerm" priority="1000" mode="M131">
...
<xsl:choose>
   ...
   <!--PATTERN LocalTerm has literal or definition-->
	...
	<!--RULE -->
<xsl:template match="term:LocalTerm" priority="1000" mode="M132">
...
<xsl:choose>
   ...
   <!--PATTERN Attribute type defined by conformant schemas-->
	...
	<!--RULE -->
<xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M137">
      <xsl:variable name="namespace"
                    select="namespace-uri-from-QName(resolve-QName(@type, .))"/>
...
<xsl:choose>
   ...
   <!--PATTERN Type base defined by conformant schemas-->
	...
	<!--RULE -->
<xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M138">
      <xsl:variable name="namespace"
...
<xsl:choose>
   ...
   <!--PATTERN list item type defined by conformant schemas-->
	...
	<!--RULE -->
<xsl:template match="xs:list[exists(@itemType)]" priority="1000" mode="M139">
      <xsl:variable name="namespace"
...
<xsl:choose>
   ...
   <!--PATTERN union member types defined by conformant schemas-->
	...
	<!--RULE -->
<xsl:template match="xs:union[exists(@memberTypes)]" priority="1000" mode="M140">
