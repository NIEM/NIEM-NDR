...
<stylesheet 
  ...
  <function name="impl:get-target-namespace" as="xs:anyURI?">
    ...
    <choose>
      ...
      <otherwise>
        <variable name="target-namespace-attr" as="attribute()?" 
                  select="$schema/@targetNamespace"/>
    ...
    <choose>
      ...
      <otherwise>
        <variable name="type" as="element()?" 
                  select="$schema/*[(self::xs:complexType
                                     or self::xs:simpleType)
                                    and @name = local-name-from-QName($qname)
                                   ][1]"/>
        <choose>
  ...
  <function name="impl:has-effective-conformance-target-identifier" as="xs:boolean">
    ...
    <variable name="effective-conformance-targets-attribute" 
              as="attribute()?"
  ...
  <extra:template-interface mode="impl:resolve-namespace" as="element(xs:schema)?">
